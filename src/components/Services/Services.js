...
function Services(props) {
  ...
  const [filteredTimeTable, setFilteredTimeTable] = React.useState(undefined);
      ...
      <div className="services" id='services'>
        {props.timeTable ?
          <>
            ...
            {filteredTimeTable ?
              <>
                {filteredTimeTable.length > 0 ? filteredTimeTable.map((item_by_dates, i) => (
                  <>
                ...
                )) : <p className='services__no-practic-cards'>Нет сеансов доступных для записи</p>}
              </>
              : <></>}
