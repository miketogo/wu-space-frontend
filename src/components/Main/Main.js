 ...
 const whyUsSlides = [
  {
    ...
    ul:[{
      text: 'Каждый мастер имеет многолетний опыт практик',
    },
    {
      text: 'У каждого разработана своя собственная уникальная методика',
    },
    {
  ...
  },
  {
    ...
    ul:[{
      text: 'Закрытый клуб, где все, что в нем происходит, остается внутри',
    },
    {
      text: 'Индивидуальный подход к каждому клиенту',
    },
    {
      text: 'Безопасное пространство продуманное до мелочей',
    },
    {
      text: 'Живое общение, интеллектуальное и духовное',
    },],
  ...
  },
  {
    ...
    {
      text: 'Уникальные практики, воркшопы, ретриты, разработанные специально для нашего клуба',
    },
    {
  ...
  },
  {
    ...
    {
      text: 'Настройка более глубокого общения с близкими в поле доверия и взаимопонимания',
    },],
    text: 'Получайте удовольствие от большого выбора практики от с помощью специалистов международного уровня. Буддиская медитация, и тайский массаж помогут вам обрести гармонию и дзен вашему телу и разуму. ',
    linkText: 'Список услуг',
    linkTo: '/services',
